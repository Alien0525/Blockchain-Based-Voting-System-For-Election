App = {
  ...
  // initWeb3 is the function that initializes our connection of client side application to our local blockchain
  initWeb3: function() {
  ...
  // loads up our contract into our frontend app
